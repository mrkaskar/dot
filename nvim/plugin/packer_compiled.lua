...
_G.packer_plugins = {
  ...
  ["lspkind.nvim"] = {
    loaded = true,
    path = "/Users/dev/.local/share/nvim/site/pack/packer/start/lspkind.nvim",
    url = "https://github.com/onsails/lspkind.nvim"
  },
  ["lspsaga.nvim"] = {
    loaded = true,
    path = "/Users/dev/.local/share/nvim/site/pack/packer/start/lspsaga.nvim",
  ...
  ["night-owl.vim"] = {
    loaded = true,
    path = "/Users/dev/.local/share/nvim/site/pack/packer/start/night-owl.vim",
  ...
  ["nvim-ts-autotag"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/Users/dev/.local/share/nvim/site/pack/packer/opt/nvim-ts-autotag",
  ...
  ["typescript.nvim"] = {
    loaded = true,
    path = "/Users/dev/.local/share/nvim/site/pack/packer/start/typescript.nvim",
    url = "https://github.com/jose-elias-alvarez/typescript.nvim"
  },
  ["vim-ReplaceWithRegister"] = {
    loaded = true,
    path = "/Users/dev/.local/share/nvim/site/pack/packer/start/vim-ReplaceWithRegister",
  ...
  ["vim-maximizer"] = {
    loaded = true,
    path = "/Users/dev/.local/share/nvim/site/pack/packer/start/vim-maximizer",
